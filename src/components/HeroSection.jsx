...
import astronot from '../assets/animation/astronot.gif'

const HeroSection = () => {
    return (
        <>
            <div className="hero-section my-5 grid grid-cols-1 gap-11 md:grid-cols-2 md:my-0 lg:gap-0 place-items-center">
                {/* hero image */}
                <div className="left">
